    ...
    <div style={{
      ...
      <div style={{
        ...
        <input
          ...
          style={{
            background: '#1a1a2e', border: '0.5px solid #3d3580', borderRadius: 10,
        ...
        <button onClick={handleSubmit} disabled={loading} style={{
          background: '#7F77DD', border: 'none', borderRadius: 10, padding: '11px',
          color: '#fff', fontSize: 13, fontWeight: 500, cursor: 'pointer'
        }}>
          {loading ? '...' : isLogin ? '로그인' : '회원가입'}
        </button>
        <div style={{ textAlign: 'center', fontSize: 12, color: '#8b84c4', cursor: 'pointer' }}
